            ...
            projects :[
                {
                    ...
                    image: {"background" : "linear-gradient(rgba(0, 0, 0, 0.45), rgba(255,110,64, 0.45)), url(' images/microservices/timestamp-ms.jpg')"},
                ...
                },
                {
                    ...
                    image: {"background" : "linear-gradient(rgba(0, 0, 0, 0.45), rgba(255,110,64, 0.45)), url(' images/microservices/request-header-parser-ms.jpg')"},
                ...
                },
                {
                    ...
                    image: {"background" : "linear-gradient(rgba(0, 0, 0, 0.45), rgba(255,110,64, 0.45)), url(' images/microservices/url-shortener-ms.jpg')"},
                ...
                },
                {
                    ...
                    image: {"background" : "linear-gradient(rgba(0, 0, 0, 0.45), rgba(255,110,64, 0.45)), url(' images/microservices/image-search-abstraction-layer-ms.jpg')"},
                ...
                },
                {
                    ...
                    image: {"background" : "linear-gradient(rgba(0, 0, 0, 0.45), rgba(255,110,64, 0.45)), url(' images/microservices/file-metadata-ms.jpg')"},
