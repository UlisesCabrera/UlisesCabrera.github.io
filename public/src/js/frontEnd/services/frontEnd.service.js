    ...
    .factory('frontEndFactory',[function() {
        ...
        var projectsFactory = { 
            projects :[{
                    ...
                    description: "The Roguelike Dungeon Crawler project is one-player game, where the dungeon is generated randomly each time you play and you have to beat the enemies to win. It was built with React.js and HTML5 Canvas",
                    image: {"background-image" : "url(' images/frontEndProjects/dungeon-game-project.jpg')"},
                    source: 'http://codepen.io/ulisescabrera/pen/RaeZwe/',
                    live: 'http://codepen.io/ulisescabrera/full/RaeZwe/',
                    userStories: [
